        ...
        <div className="group relative flex flex-col overflow-hidden rounded-2xl bg-white shadow-sm transition-all hover:shadow-md dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800">
            ...
            <div className="flex flex-1 flex-col p-4">
                ...
                <div className="mt-4 flex gap-2">
                    ...
                    <button className="flex h-10 w-10 items-center justify-center rounded-lg border border-zinc-200 text-zinc-400 transition-colors hover:border-[#f98109] hover:text-[#f98109] dark:border-zinc-800">
